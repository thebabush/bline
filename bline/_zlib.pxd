...
"""
https://github.com/samrushing/zstream/blob/master/zlib.pxd
"""
...
cdef extern from "zlib.h":
    ...
    cdef int deflateInit2 (z_stream *, int, int, int, int, int)
    ...
    cdef enum COMPRESSION_METHOD:
        Z_DEFLATED = 8

    cdef enum COMPRESSION_STRATEGY:
        Z_FILTERED         = 1
        Z_HUFFMAN_ONLY     = 2
        Z_RLE              = 3
        Z_FIXED            = 4
